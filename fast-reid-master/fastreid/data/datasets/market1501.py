...
class Market1501(ImageDataset):
    ...
    def __init__(self, root='datasets', market1501_500k=False, **kwargs):
        ...
        data_dir = osp.join('E:\\Videos\\1012\\D06\\D1D2')
        ...
        self.train_dir = osp.join(self.data_dir, '1')
        self.query_dir = osp.join(self.data_dir, 'D01_20211012')
        self.gallery_dir = osp.join(self.data_dir, 'D02_20211012')
